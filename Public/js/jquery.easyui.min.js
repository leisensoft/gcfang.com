...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"请输入",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_424,blur:_428,mouseenter:_42c,mouseleave:_42f,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
_97c(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_98f){
